...
const BUTTON_VARIANTS = {
  default:
    'py-1.5 px-3 rounded-md border-2 border-transparent transition disabled:bg-gray-400 disabled:border-gray-400 disabled:text-white disabled:cursor-not-allowed',
